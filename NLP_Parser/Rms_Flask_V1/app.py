""" Root API and Functionality of the NLP Parser """
try:
    ...
    print("Enable to import all the necessary Modules---", err)
    sys.exit()
...
class RatemyService(Resource):
    ...
    def get(self):
        """ Get Request Call """
        return jsonify({"res":"Please use the Post method to run the API"})

    def post(self):
        """NLP Review Parser and Analyzer """
        start = time.time()

        parser = reqparse.RequestParser()
        parser.add_argument('reviewId', type=int, help='Id of the Review Submitted by the user')
        parser.add_argument('LikeliRecommend', type=int, help='Recommendation Rating')
        parser.add_argument('CustomerEffort', type=int, help='Customer Efforts Rating')
        parser.add_argument('QualityCommunication', type=int, help='Quality of Communication Driver Rating')
        parser.add_argument('QualityService', type=int, help='Quality of Service Driver Rating')
        parser.add_argument('QualityStaff', type=int, help='Quality of Staff Driver Rating')
        parser.add_argument('ValueForMoney', type=int, help='Value For Money Driver Rating')
        parser.add_argument('Comments', type=str, help='Review or Comment Submitted by the user')

        args = parser.parse_args()

        review_id = args['reviewId']
        orating = args['LikeliRecommend']
        customer_effort = args['CustomerEffort']
        qoc = args['QualityCommunication']
        qoservice = args['QualityService']
        qostaff = args['QualityStaff']
        vfm = args['ValueForMoney']
        review = args['Comments']
...
if __name__ == "__main__":
    api.add_resource(RatemyService, '/')
